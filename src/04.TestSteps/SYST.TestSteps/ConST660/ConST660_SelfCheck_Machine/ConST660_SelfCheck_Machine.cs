...
namespace SYST.TestSteps.ConST660.ConST660_SelfCheck_Machine;

/// <summary>
/// ConST660 温度检定炉整机自检处理器集合（清单 Key=ConST660_SelfCheck_Machine）。测试项逻辑共享 <see cref="ConST660Ops"/>，
/// 本文件仅提供 DeviceFamily=清单 Key 的处理器注册（引擎按 manifest.Key 解析）。
/// PORT: 旧脚本方法 <c>T01_SelftCheckTest_Dev</c>。
/// </summary>
/// <summary>
/// ConST660 温度检定炉整机自检：ConST660SelfCheck 测试项。
/// </summary>
public sealed class ConST660SelfCheckHandler : IStepHandler
{
    public string Kind => "ConST660SelfCheck";
    public string? DeviceFamily => "ConST660_SelfCheck_Machine";
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestWriteSN 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestWriteDevType 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestWriteRange 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestSoftVersions 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：LCDBadPixelTest 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：LCDTouchTest 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestSpeaker 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：SystemVoltageTest 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestUSBPrincipal 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestUSBSubordinate 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestStorageCardPrincipal 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestClock 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestWifi 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestBluetooth 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestControlTemperature 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestControlTemperature_TLL_LTC 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestControlTemperature2 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestElectricalCom0 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestElectricalIO 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestControllerCom3 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：TestControllerIO 测试项。
/// </summary>
...
/// <summary>
/// ConST660 温度检定炉整机自检：PowerOnOffTest 测试项。
/// </summary>
